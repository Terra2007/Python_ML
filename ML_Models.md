...
![img](C:\Users\user\Desktop\Python_ML\ML_Models\1)
...
![평균제곱오차 MSE - 제타위키](C:\Users\user\Desktop\Python_ML\ML_Models\2)
...
* Loss Function MSE ( Mean Squared Error )
  ...
  손실을 구할때 가장 널리 쓰이는 방법으로 실제 값 - 예측 데이터를 제곱을 해서 평균을 한 것으로
   ...
   ![image-20210819151051481](C:\Users\user\Desktop\Python_ML\ML_Models\3)
  ...
  ![MSE(Mean Squared Error) 간단 정리](C:\Users\user\Desktop\Python_ML\ML_Models\4)

### 경사하강법 Gradient Descent

경사하강법 ( Gradient Descent)는 손실을 최소화 하기 위한 방법 입니다.

![Gradient Descent and Stochastic Gradient Descent - mlxtend](C:\Users\user\Desktop\Python_ML\ML_Models\5)
...
![Linear regression with multiple features - Do It Easy With ScienceProg](C:\Users\user\Desktop\Python_ML\ML_Models\6)
...
![Setting the learning rate of your neural network.](C:\Users\user\Desktop\Python_ML\ML_Models\7)
...
![학습률 (Learning rate)](C:\Users\user\Desktop\Python_ML\ML_Models\8)
...
![image-20210819171843323](C:\Users\user\Desktop\Python_ML\ML_Models\9)
...
* **로지스틱 함수**
  ...
  ![image-20210819173820049](C:\Users\user\Desktop\Python_ML\ML_Models\10)

  베르누이 시도에서 1이 나올 확률 μ와 0이 나올 확률 1−μ의 비율(ratio)을 승산비(odds ratio)라고 합니다.

  ![image-20210819174124446](C:\Users\user\Desktop\Python_ML\ML_Models\11)

  위 식인 승산비를 로그 변환한 것이 로지트함수(Logit function)입니다.

  로지트함수의 값은 로그 변환에 의해 **음의 무한대(−∞)부터 양의 무한대 (+∞)**까지의 값을 가질 수 있습니다.

  ![image-20210819174222293](C:\Users\user\Desktop\Python_ML\ML_Models\12)
  ...
  ![img](C:\Users\user\Desktop\Python_ML\ML_Models\13)
...
![image-20210819223143689](C:\Users\user\Desktop\Python_ML\ML_Models\17)
...
![image-20210819223356021](C:\Users\user\Desktop\Python_ML\ML_Models\18)

우선 위와 같이 데이터를 가장 잘 구분 할 수 있는 질문을 기준으로 나눕니다.

![image-20210819223424419](C:\Users\user\Desktop\Python_ML\ML_Models\19)

나뉜 각 범주에서 가장 잘 구분 할수 있는 질문을 기준으로 또 나눕니다.

![image-20210819223501738](C:\Users\user\Desktop\Python_ML\ML_Models\20)
...
![image-20210819223736757](C:\Users\user\Desktop\Python_ML\ML_Models\21)
...
![image-20210819224127565](C:\Users\user\Desktop\Python_ML\ML_Models\22)
...
* 앙상블 학습 유형
  ...
  * 보팅(Voting)
    * 하드 보팅(Hard Voting)
      ...
      * ![앙상블(Ensemble) 기법](C:\Users\user\Desktop\Python_ML\ML_Models\23)
    * 소프트 보팅(Soft Voting)
      * 모든 분류기가 예측한 레이블 값의 결정 확률 평균을 구한 뒤 가장 확률이 높은 레이블 값을 최종 결과로 선정
      * ![앙상블(Ensemble) 기법](C:\Users\user\Desktop\Python_ML\ML_Models\24)

  * 배깅(Bagging)

    * ![머신러닝 - 11. 앙상블 학습 (Ensemble Learning): 배깅(Bagging)과 부스팅(Boosting)](C:\Users\user\Desktop\Python_ML\ML_Models\25)
  ...
  * 부스팅(Boosting)
    ...
    * ![img](C:\Users\user\Desktop\Python_ML\ML_Models\26)
...
![image-20210819225520070](C:\Users\user\Desktop\Python_ML\ML_Models\27)
...
![image-20210819215922023](C:\Users\user\Desktop\Python_ML\ML_Models\28)

AdaBoost는 아래와 같이 여러 개의 stump로 구성이 되어있습니다. 이를 Forest of stumps라고 합니다.

![image-20210819220002848](C:\Users\user\Desktop\Python_ML\ML_Models\29)
...
![image-20210819220345382](C:\Users\user\Desktop\Python_ML\ML_Models\30)
...
![image-20210819221139788](C:\Users\user\Desktop\Python_ML\ML_Models\31)
...
![image-20210819221345580](C:\Users\user\Desktop\Python_ML\ML_Models\32)
...
![image-20210819221657766](C:\Users\user\Desktop\Python_ML\ML_Models\33)
...
![img](C:\Users\user\Desktop\Python_ML\ML_Models\34)
...
![img](C:\Users\user\Desktop\Python_ML\ML_Models\35)
...
![image-20210819222505829](C:\Users\user\Desktop\Python_ML\ML_Models\36)
